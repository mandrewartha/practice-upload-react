...
//Import the IssueItem component here
...
describe('IssueItem', () => {
  ...
  it('should contain the expected text', () => {
    act(() => {
      // Add a render code block that checks to see if the component renders properly
  ...
  //render the IssueItem component and format the rendered HTML with the pretty package before saving it as an snapshot.
